...
- 日常开发流程：见 `DEVELOPMENT_WORKFLOW.md`
- 标准顺序：`issue -> branch -> code -> tests -> PR -> review -> merge`
- CodeGraph 用于理解代码结构和影响面；Task Manager 用于拆解和跟踪任务；GitHub issue 和 PR 是正式留痕与审批入口。
